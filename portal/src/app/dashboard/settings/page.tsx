...
export default function SettingsPage() {
  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    try {
      if (isTeacher) {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://omniattend-backend-production.up.railway.app"}/api/profile/teacher/${user.teacher_id}`, {
          method: "PUT",
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://omniattend-backend-production.up.railway.app"}/api/profile/student/${user.student_id}`, {
          method: "PUT",
          body: fd
        });
  ...
  const handleTestVoiceMatch = async () => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://omniattend-backend-production.up.railway.app"}/api/profile/student/${user.student_id}/test-voice`, {
        method: "POST",
        body: fd
      });
